# -*- coding: utf-8 -*-
"""2022冬季版_純用AWS做出機器人.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Vy2-I9dmsuByrTJPRMDYoK6ky64zXVmB
"""
...
client_aws_access_key_id = os.environ["AWS_ACCESS_KEY_ID"]
client_aws_secret_access_key =  os.environ["AWS_SECRET_ACCESS_KEY"]
client_aws_session_token= os.environ["AWS_SESSION_TOKEN"]

# 模型在AWS的位置
model_arn=os.environ["AWS_MODEL_ARN"]

# 存放消費者上傳照片的桶子名
client_bucket_name=os.environ["CLIENT_BUCKET_NAME"]
client_region_name="us-east-1"

# 載入劇本Excel
import pandas as pd
plot_content = pd.read_excel("008_drama.xlsx")
...
def handle_image_message(event):
    ...
    if reply_text != '這個AI模型無法辨認你想知道的事情':
      ...
      line_bot_api.reply_message(
        event.reply_token,
        TextSendMessage('請嘗試再靠近一些，進行拍攝。或是這張照片，我們的AI模型看不懂。')
      )
